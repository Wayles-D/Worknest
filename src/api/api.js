...
// NOTIFICATIONS API
export const createNotification = async (notificationData, accessToken) => {
  return await axiosInstance.post(
...
export const getNotificationById = async (id, accessToken) => {
  return await axiosInstance.get(`/notifications/${id}`, headers(accessToken));
};
export const deleteNotification = async (id, accessToken) => {
  return await axiosInstance.delete(`/notifications/${id}`, headers(accessToken));
};
export const deleteAllNotifications = async (accessToken) => {
  return await axiosInstance.delete("/notifications", headers(accessToken));
};
export const markNotificationAsRead = async (id, accessToken) => {
  return await axiosInstance.patch(
...
export const markAllNotificationsAsRead = async (accessToken) => {
  return await axiosInstance.patch("/notifications/mark/all-read", {}, headers(accessToken));
};
export const getUnreadNotificationsCount = async (accessToken) => {
  return (await axiosInstance.get("/notifications/unread/count", headers(accessToken))).data;
};